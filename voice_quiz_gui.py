...
def speak(text):
    threading.Thread(target=lambda: engine.say(text) or engine.runAndWait(),
                     daemon=True).start()
...
class VoiceQuizApp:
    def __init__(self, root):
        ...
        # Intro (spoken once)
        speak("Hello, I am your quiz robot. I will ask ten questions. "
              "You can speak or click the answer. Let's begin!")
